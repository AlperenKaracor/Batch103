...
/*
Deque: Double ended Queue manasindadir Yani iki ucli Queue demektir.
FIFO ve LIFO berbaer gerektiginde kullanilir
 */
...
bu deque tarafından temsil edilen yığına (başka bir deyişle, bu deque'nin başında) bir öğeyi iter,
 ...
 */
      /*
        ...
        furnitureTruck.push("Refrigetor");
        System.out.println(furnitureTruck);//[Refrigetor, Chair, Mirror, Sofa, Bed, Bed, Bed, Dining Table]
