...
/*
1)Siz HashMap<String, Double> salaries = new HashMap<>(); bu kodu yazdiginiz zaman memory de 16 kutu(bucket)
iceren bir yapi olusturur ve bu yapidaki herbir kutuya index verir.Index ler 0 dan 15 e kadardir
2)Siz salaries.put("QA",110000.00); kodunu yazdiginizda key icin bir HashCode olusturur  bu HashCode u
15 e boler ve kalani index olarak kullanir ve bu elemani o index e yerlestirir
3) Yerlestirirken 4 lu bir yapi olusturur bu yapinin ilk bolumune HashCode u koyar ikinci bolumune key i ucuncu
bolumune value yi ve dorduncu bolumune pointer i koyar Bu cok bolumlu yapi LinkedList lerdeki Node dur yani HashMap
bucketlara koydugu datayi LinkedList olarak depolar
4)Java null icin hep HashCode olarak zero uretir o yuzden key null oldugunda eleman ilk bucketa
yerlestirilir.Bundan dolaayi key si nill olan elemanlar Map in icinde genellikle ilk sirada gozukurler
5)Java normalde HashCodelari unique yapar ama bazen trafik kazasi gibi farkli 2 eleman
icin ayni hashCode uretileblir Buna Hash Collision denir. hash Collision meshur bir java development problemidir
Bu problem ile karsilasildiginda developerlar bu problemi cozmek icin kodlar yazarlar Ama bu core javanin konusu degildir
 */
/*
